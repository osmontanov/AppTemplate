...
nonisolated enum LocalNotificationDiagnosticReason: String, Codable, CaseIterable, Hashable, Sendable { case missingEnvelope, corruptEnvelope, unsupportedEnvelopeVersion, identifierMismatch, invalidDeepLink, unrecognizedAction }
