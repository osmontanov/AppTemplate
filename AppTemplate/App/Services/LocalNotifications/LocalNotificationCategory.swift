...
nonisolated struct LocalNotificationCategory: Hashable, Codable, Sendable {
    let id: LocalNotificationCategoryID; let actions: [LocalNotificationAction]; let hiddenPreviewsBodyPlaceholder: String?; let categorySummaryFormat: String?; let hiddenPreviewsShowTitle: Bool; let hiddenPreviewsShowSubtitle: Bool; let reportsDismissal: Bool
    init(id: LocalNotificationCategoryID, actions: [LocalNotificationAction] = [], hiddenPreviewsBodyPlaceholder: String? = nil, categorySummaryFormat: String? = nil, hiddenPreviewsShowTitle: Bool = false, hiddenPreviewsShowSubtitle: Bool = false, reportsDismissal: Bool = false) { self.id = id; self.actions = actions; self.hiddenPreviewsBodyPlaceholder = hiddenPreviewsBodyPlaceholder; self.categorySummaryFormat = categorySummaryFormat; self.hiddenPreviewsShowTitle = hiddenPreviewsShowTitle; self.hiddenPreviewsShowSubtitle = hiddenPreviewsShowSubtitle; self.reportsDismissal = reportsDismissal }
}
